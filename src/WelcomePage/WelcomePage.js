...
function Footer() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      <Link
        color="inherit"
        href="https://www.linkedin.com/in/aresky-berkane/"
        target="_blank"
      >
        <img
          alt="img"
    ...
    <React.Fragment>
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography
              ...
              paragraph
            >
              Learn to improve your memory through simple exercises based on
              mnemonic principles, learn the first thousand decimals of Pi by
              using the Major System and the Mental Palace. Start now by logging
              in and let the journey begin!
            </Typography>
      ...
      <footer className={classes.footer}>
        ...
        <Typography
          ...
          component="p"
        >
          I am a software developer passionated about learning and creating new
          ideas and inventions. If you are a recruiter or have a startup and
          would like to have me on your team, please contact me :)
        </Typography>
        <Footer />
      </footer>
      {/* End footer */}
